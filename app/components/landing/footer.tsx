...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col px-8 md:px-16 border-t">
      <div className="w-full flex flex-col justify-start py-8">
        <div className="flex items-center py-8">
          <Image
            ...
            height={50}
          />
          <Label className="text-lg tracking-wide font-semibold ml-4 ">
            GateKeeper
          </Label>
        </div>
        <Label className="text-lg tracking-wide font-light ">
      ...
      <div className="w-full flex items-center justify-between mx-auto py-8">
        <Label className="">&copy; 2026 Gatekeeper. All rights reserved.</Label>
